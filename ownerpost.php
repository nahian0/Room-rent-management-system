        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                    ...
                    <form method="POST">
						...
						<div class="form-row">
						  ...
						  <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-6" type="text" name="city" placeholder="id" required/ >
                                </div>
                            </div>
                        </div>
						  ...
						  <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-6" type="text" name="area" placeholder="id" required/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="details" placeholder="write details here.." required/ ></textarea>
                                </div>
                            </div>
                        </div>
                       <div> 
                ...
                <div class="card-footer">
                    <button class="btn btn--radius-2 btn--blue-2" name= "submit" type="submit">Send Application</button>
                </div>
            </div>
        </div>
    </div>
...
<?php 
    if(isset($_POST['submit']))
    {
        ...
        $query = "insert into room(room_id,room_price,images,images1,images2,room_discription,city,area,owner_id) values ('$id','$price','$image','$image1','$image2','$details','$city','$area','$ownerid')";
